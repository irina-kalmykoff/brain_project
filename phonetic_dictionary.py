...
class PhoneticDictionary(DebugMixin):
    ...
    'Kan je vanavond meegaan naar het concert?': 'kɑn jə vɑnˈaːvɔnt ˈmeːˌɣaːn naːr hət kɔnˈsɛrt',
    ...
    def extract_phonemes(self, word: str) -> List[str]:
        ...
        if word not in self:
            # If word not in dictionary, return characters as approximation
            return list(word.strip(string.punctuation + '""„"''.\r\n').lower())
