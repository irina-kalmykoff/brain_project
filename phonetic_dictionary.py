...
class PhoneticDictionary(DebugMixin):
    ...
    DUTCH_PHONETIC_DICT = {
            ...
            'Elke maakt savonds de brievenbus leeg': 'ˈɛlkə maːkt ˈsaːvənts də ˈbrivənbʏs leːx',
            ...
            'Faraos werden zowel in piramides als in uitgegraven rotsen begraven': 'faˈraːoːs ˈʋɛrdən zoˈʋɛl ɪn piraˈmidəs ɑls ɪn ˈœytɣəˌɣraːvən ˈrɔtsən bəˈɣraːvən',
            ...
            'Het ontbijt is tussen zeven en tien uur sochtends': 'hət ˈɔntbɛit ɪs ˈtʏsən ˈzeːvən ɛn tin yːr ˈsɔxtənts',
            ...
            'Iedere avond maak ik tijd voor mijn hobbys': 'ˈidərə ˈaːvɔnt maːk ɪk tɛit voːr mɛin ˈhɔbis',
            ...
            'In Australië leven kangoeroes en koalas in het wild': 'ɪn ɑuˈstraːlijə ˈleːvən kɑŋɣəˈrus ɛn koˈaːlaːs ɪn hət ʋɪlt',
            ...
            'In Hilversum worden veel televisieprogrammas gemaakt': 'ɪn ˈhɪlvərsʏm ˈʋɔrdən veːl teːləˈviziˌproˌɣrɑmaːs ɣəˈmaːkt',
    ...
    def count_phonemes(self, word: str) -> int:
        ...
        word_cleaned = word_cleaned.replace("'", "").replace("'", "")
